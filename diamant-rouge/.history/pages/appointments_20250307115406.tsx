...
/* Hero Section with diamond-preserving design */}
<section className="relative h-[80vh] flex items-center">
    {/* Background Image with Diamond */}
    <Image
        ...
        priority
    />
    {/* Custom asymmetrical gradient protecting the diamond in center-right area */}
    <div className="absolute inset-0 bg-gradient-to-r from-richEbony/95 via-richEbony/60 to-transparent z-0" />
    
    {/* Additional protective radial gradient to highlight diamond */}
    <div className="absolute right-1/3 inset-y-0 w-1/3 bg-radial-spotlight z-0 opacity-60" />

    {/* Hero Content */}
    <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 items-center">
            {/* Text content positioned to the left - takes 3 columns */}
            <motion.div
            ...
            >
                ...
                <p className="mt-4 text-xl text-brandIvory font-light md:pr-12">
            ...
            {/* Decorative elements to the far left (2 columns) - positioned away from central diamond */}
            <motion.div
                className="hidden md:flex md:col-span-2 justify-start items-center relative"
                initial="hidden"
                animate="visible"
                variants={scaleIn}
            >
