...
{currentStep === 1 && (
  ...
  >
    ...
    <div className="space-y-6">
      <div className="space-y-4">
        <label className={`block p-5 border rounded-lg transition-all cursor-pointer ${
          paymentMethod === "CMI" 
            ? "border-burgundy bg-burgundy/5 shadow-sm" 
            : "border-platinumGray/30 hover:border-burgundy/30"
        }`}>
...
<div className="mt-8 flex justify-between">
  ...
  <button
    ...
    disabled={loading}
    className={`px-8 py-3 rounded-full bg-brandGold text-white hover:bg-burgundy transition-all flex items-center justify-center shadow-lg ${
...
<div>
<div className={`bg-white rounded-xl shadow-luxury p-6 md:p-8 ${
  !showOrderSummary && "lg:block hidden"
}`}>
