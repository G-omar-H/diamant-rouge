                                    ...
                                    >
                                        ...
                                        <div className="flex-1">
                                            <div className="flex justify-between items-center mb-2">
                                                <h4 className="font-medium text-richEbony text-base">{type.title}</h4>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="relative">
            ...
            <div className="relative">
                ...
                <div className="absolute bottom-0 left-0 h-px w-full bg-gradient-to-r from-transparent via-brandGold/30 to-transparent transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></div>
            </div>
            <div className="absolute -bottom-px left-0 w-0 h-px bg-gradient-to-r from-transparent via-brandGold to-transparent group-focus-within:w-full transition-all duration-500"></div>
        </div>
        ...
        <div className="relative">
            ...
            <div className="relative">
                ...
                >
                    ...
                    <option value="champagne">Champagne Rosé</option>
