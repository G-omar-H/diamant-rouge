...
export default function CollectionsPage({
    ...
    // Sort function - MOVED UP before filterProducts
    const sortProducts = (productsToSort: any[]) => {
        ...
        return sorted; // REMOVED setTimeout call here that was causing issues
    };
    ...
    useEffect(() => {
        ...
        const timer = setTimeout(() => {
            setLoading(false);
        }, 400); // Simulate some loading time for smooth transitions
        
        return () => clearTimeout(timer);
    }, [selectedCategory, selectedMaterial, selectedGemType, priceRange, sortOption]);
        ...
        <>
            <NextSeo
                ...
                openGraph={{
                    ...
                    images: [
                        {
                            url: "public/images/rings/08a58c59664d--Aurate-Holiday-36kira-1v2.jpg",
                            width: 1200,
                            height: 630,
            ...
            <div className="min-h-screen bg-brandIvory">
                ...
                <section className="relative h-[50vh] min-h-[400px] flex items-center justify-center overflow-hidden">
                    <div className="absolute inset-0 z-0">
                        <Image
                            src="public/images/rings/08a58c59664d--Aurate-Holiday-36kira-1v2.jpg"
                            alt="Collections Diamant Rouge"
                            layout="fill"
                            objectFit="cover"
                            quality={90}
