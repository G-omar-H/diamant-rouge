...
export async function getServerSideProps(context: any) {
    ...
    try {
        ...
        const featuredProducts = await prisma.product.findMany({
            ...
            take: 8, // Increased for carousel display
        });
    ...
    return (
        <>
            ...
            */}
            ...
            {/* 
            ----------------------------------------------------
            💎 2. COLLECTIONS PRESTIGIEUSES - Horizontal product carousel 
            ----------------------------------------------------
            */}
            <motion.section
            ...
            >
                ...
                <div className="relative">
                    ...
                    <button
                        ...
                        className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-brandIvory/80 backdrop-blur-sm p-2 rounded-full border border-brandGold/20 hover:border-brandGold transition-all"
                    >
                        <ChevronLeft size={24} className="text-richEbony" />
                    </button>

                    {/* Products scroll container */}
                    <div 
                        ref={carouselRef}
                        className="flex overflow-x-auto scrollbar-hide snap-x scroll-smooth pb-8 -mx-4 px-8"
                    ...
                    <button
                        ...
                        className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-brandIvory/80 backdrop-blur-sm p-2 rounded-full border border-brandGold/20 hover:border-brandGold transition-all"
                    >
                        <ChevronRight size={24} className="text-richEbony" />
                    </button>
                </div>
