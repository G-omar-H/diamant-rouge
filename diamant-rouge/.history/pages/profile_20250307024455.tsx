                        ...
                        <div className="sticky top-24">
                            ...
                            <div className="space-y-3">
                                <button
                                    ...
                                    className={`flex items-center w-full px-3 py-2.5 text-left transition-all ${activeSection === "personal"
                                ...
                                <button
                                    ...
                                    className={`flex items-center w-full px-3 py-2.5 text-left transition-all ${activeSection === "address"
                                        ? "bg-brandGold/5 border-l-2 border-brandGold text-richEbony"
                                        : "text-platinumGray hover:bg-brandGold/5"
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`flex items-center w-full px-3 py-2.5 text-left transition-all ${activeSection === "preferences"
                                        ? "bg-brandGold/5 border-l-2 border-brandGold text-richEbony"
                                        : "text-platinumGray hover:bg-brandGold/5"
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`flex items-center w-full px-3 py-2.5 text-left transition-all ${activeSection === "orders"
                                        ? "bg-brandGold/5 border-l-2 border-brandGold text-richEbony"
                                        : "text-platinumGray hover:bg-brandGold/5"
                                        }`}
                                >
                                    ...
                                    <form onSubmit={handleSavePersonal} className="space-y-6">
                                        ...
                                        <div className="flex items-center justify-between">
                                            <button
                                                ...
                                                className={`px-6 py-3 bg-richEbony text-white hover:bg-burgundy transition-colors duration-300 font-medium tracking-wide ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''
                                                    }`}
                                            >
                                                ...
                                                >
                                                    <div className="p-6 border-b border-brandGold/10 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <span className={`inline-flex px-3 py-1 text-xs rounded-sm ${order.status === 'completed' ? 'bg-emerald-50 text-emerald-700' :
...
export async function getServerSideProps(context) {
    ...
    try {
        ...
        // Next Auth sessions may use string IDs while your DB uses integers
        if (!session.user.id) {
