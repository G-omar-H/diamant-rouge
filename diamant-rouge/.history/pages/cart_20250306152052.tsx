                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center justify-between mt-4">
                          <div className="flex items-center border border-platinumGray/30 rounded-md">
                            <button 
                              onClick={() => updateQuantity(item.productId, item.variationId, Math.max(1, item.quantity - 1))}
              ...
              <div className="bg-white rounded-lg shadow-luxury p-6 sticky top-24">
                ...
                <div className="mt-8 pt-6 border-t border-platinumGray/10">
                  ...
                  <div className="flex justify-center items-center space-x-4 mb-6">
                    <Image src="/images/icons/visa.svg" width={40} height={24} alt="Visa" />
                    <Image src="public/images/icons/mastercard-old.svg" width={40} height={24} alt="Mastercard" />
                    <Image src="/images/icons/amex.svg" width={40} height={24} alt="American Express" />
                  </div>
