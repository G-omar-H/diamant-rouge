...
export default function AdminDashboard() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-brandIvory">
      ...
      {/* Footer */}
      <footer className="bg-white/30 backdrop-blur-sm border-t border-brandGold/20 py-4">
        <div className="container mx-auto px-6 text-center">
          <p className="text-sm text-platinumGray">
            © {new Date().getFullYear()} Maison Diamant Rouge. Tous droits réservés.
          </p>
        </div>
      </footer>
    </div>
