...
const styles = {
  sectionHeading: `text-lg font-serif text-richEbony font-medium mb-4 relative
                   after:content-[''] after:absolute after:bottom-[-4px] after:left-0 
                   after:h-[2px] after:w-16 after:bg-gradient-to-r after:from-brandGold/60 after:to-transparent`,
  
  panelHeading: `font-serif text-richEbony mb-1 text-base font-medium`,

  productTitle: `text-sm font-medium text-richEbony line-clamp-1 leading-tight`
          ...
          <div className="max-w-3xl mx-auto bg-white shadow-luxury rounded-xl p-8 md:p-12">
            ...
            <div className="border-t border-b border-platinumGray/10 py-8 my-8">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="text-center">
                  <h3 className="font-serif text-richEbony mb-2 text-base">Numéro de Commande</h3>
                  <p className="text-brandGold font-medium">#DR{Math.floor(Math.random() * 100000)}</p>
                </div>
                <div className="text-center">
                  <h3 className="font-serif text-richEbony mb-2 text-base">Date de Livraison</h3>
                ...
                <div className="text-center">
                  <h3 className="font-serif text-richEbony mb-2 text-base">Méthode de Paiement</h3>
                  <p className="text-platinumGray">
            ...
            <div className="space-y-6 mb-12">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-serif text-richEbony text-base">Suivi de Commande</h3>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-serif text-richEbony text-base">Service Exclusif</h3>
                  <p className="text-sm text-platinumGray">
                    ...
                    >
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="mt-8 pt-6 border-t border-platinumGray/10">
                          <h3 className={styles.sectionHeading}>Options de Présentation</h3>
                        ...
                        <div className="space-y-6">
                          ...
                          <div className="bg-brandGold/5 rounded-lg p-5">
                            <div className="flex items-start">
                              ...
                              <div>
                                <h3 className={styles.panelHeading}>Adresse de Livraison</h3>
                                <p className="text-sm text-platinumGray">
                          ...
                          <div className="bg-brandGold/5 rounded-lg p-5">
                            <div className="flex items-start">
                              ...
                              <div>
                                <h3 className={styles.panelHeading}>Méthode de Paiement</h3>
                                <p className="text-sm text-platinumGray">
                                  {paymentMethod === "CMI" ? (
                          ...
                          <div className="bg-brandGold/5 rounded-lg p-5">
                            <div className="flex items-start">
                              ...
                              <div>
                                <h3 className={styles.panelHeading}>Options Sélectionnées</h3>
