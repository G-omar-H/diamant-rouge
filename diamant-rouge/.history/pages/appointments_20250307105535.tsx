                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        >
                            <div className="flex items-center mb-6">
                                ...
                                />
                                <div className="ml-4">
                                    <h4 className="text-richEbony font-medium">Sophie Laurent</h4>
                        ...
                        >
                            <div className="flex items-center mb-6">
                                ...
                                />
                                <div className="ml-4">
                                    <h4 className="text-richEbony font-medium">Karim Benali</h4>
                        ...
                        >
                            <div className="flex items-center mb-6">
                                ...
                                />
                                <div className="ml-4">
                                    <h4 className="text-richEbony font-medium">Laila Moussaoui</h4>
