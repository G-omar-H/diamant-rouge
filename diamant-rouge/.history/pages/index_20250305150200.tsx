        ...
        <>
            ...
            */}
            ...
            >
                ...
                {/* Products carousel with centered scrolling */}
                <div className="relative">
                    {/* Carousel container with padding to allow centering of edge items */}
                    <div className="relative mx-auto max-w-screen-xl overflow-hidden">
                        <div 
                            ref={carouselRef}
                            className="flex overflow-x-auto custom-scrollbar snap-x scroll-smooth pb-8 px-0"
                            style={{ 
                    ...
                    {/* Initial product positioning - scroll to first product */}
