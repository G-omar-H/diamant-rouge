...
export default function AppointmentPage() {
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="relative group">
            ...
            <div className="relative">
                <select
                    className="w-full appearance-none border border-gray-200 p-4 pr-12 bg-transparent hover:border-brandGold/50 focus:border-brandGold focus:ring-0 outline-none transition-all duration-300 rounded-sm text-richEbony"
                    value={guests}
                ...
                <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-4">
                    <div className="w-6 h-6 rounded-full bg-brandGold/10 flex items-center justify-center">
                        <ChevronDown size={14} className="text-brandGold" />
                    </div>
                </div>
            ...
            <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-2 h-2 rounded-full bg-brandGold/20 opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity duration-300"></div>
                                ...
                                <div className="relative group">
                                    ...
                                    <div className="relative">
                                        ...
                                        <div className="absolute bottom-0 left-0 h-0.5 w-0 bg-gradient-to-r from-transparent via-brandGold to-transparent group-hover:w-full transition-all duration-500">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="mt-10 relative group">
                                ...
                                <textarea
                                    className="w-full border border-gray-200 p-4 bg-transparent focus:border-brandGold focus:ring-1 focus:ring-brandGold outline-none transition-all rounded-sm min-h-[120px] text-richEbony"
                                    placeholder="Partagez-nous toute information qui pourrait nous aider à personnaliser votre visite"
                                    value={specialRequests}
                                    onChange={(e) => setSpecialRequests(e.target.value)}
                                ></textarea>
                                <div className="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-transparent via-brandGold to-transparent group-hover:w-full transition-all duration-500"></div>
                            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        >
                            <div className="flex items-center mb-6">
                                ...
                                />
                                <div className="ml-4">
                                    <h4 className="text-base text-richEbony font-medium">Sophie Laurent</h4>
                        ...
                        >
                            <div className="flex items-center mb-6">
                                ...
                                />
                                <div className="ml-4">
                                    <h4 className="text-base text-richEbony font-medium">Karim Benali</h4>
                        ...
                        >
                            <div className="flex items-center mb-6">
                                ...
                                />
                                <div className="ml-4">
                                    <h4 className="text-base text-richEbony font-medium">Laila Moussaoui</h4>
