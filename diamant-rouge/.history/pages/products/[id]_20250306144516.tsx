...
import { 
  Shield, Certificate, Package, ZoomIn, 
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-wrap items-center gap-4 pt-4">
                <div className="flex items-center space-x-2 text-xs text-platinumGray bg-richEbony/5 px-3 py-1.5 rounded-full">
                  <Certificate size={14} className="text-brandGold" />
                  ...
                  {activeTab === 'certificate' && (
                    <div>
                      <div className="flex items-start space-x-4 mb-4">
                        <Certificate size={32} className="text-brandGold flex-shrink-0" />
                        <div>
              ...
              <div className="p-6">
                ...
                <div className="space-y-6">
                  <Image 
                    ...
                    width={800} 
                    height={500} 
                    alt="Certificat GIA" import { GetServerSideProps } from "next";
import { prisma } from "../../lib/prisma";
import Image from "next/image";
import { useState, useMemo, useRef } from "react";
import { useCart } from "../../contexts/CartContext";
