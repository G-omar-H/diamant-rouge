...
export default function Footer() {
  ...
  return (
    <footer className="bg-brandIvory border-t border-brandGold/20 text-richEbony pt-16 mt-auto">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        {/* Enhanced Luxury Newsletter Section */}
        <div className="mb-16 relative">
          <div className="absolute inset-0 bg-burgundy/5 rounded-xl"></div>
          
          <div className="relative max-w-3xl mx-auto px-8 py-10 border border-brandGold/30 rounded-xl overflow-hidden">
            {/* Decorative corner elements */}
            <div className="absolute top-0 left-0 w-16 h-16 border-t-2 border-l-2 border-brandGold/30 rounded-tl-lg"></div>
            <div className="absolute top-0 right-0 w-16 h-16 border-t-2 border-r-2 border-brandGold/30 rounded-tr-lg"></div>
            <div className="absolute bottom-0 left-0 w-16 h-16 border-b-2 border-l-2 border-brandGold/30 rounded-bl-lg"></div>
            <div className="absolute bottom-0 right-0 w-16 h-16 border-b-2 border-r-2 border-brandGold/30 rounded-br-lg"></div>
            
            {/* Diamond accent */}
            <div className="absolute -top-1 left-1/2 transform -translate-x-1/2">
              <Diamond size={10} className="text-brandGold fill-brandGold" />
            </div>
            
            <div className="text-center">
              <h4 className="text-2xl md:text-3xl font-serif text-brandGold mb-2">
                Le Cercle Diamant Rouge
              </h4>
              <div className="h-px w-40 mx-auto bg-burgundy/30 mb-4"></div>
              <p className="text-platinumGray max-w-xl mx-auto mb-8">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <div className="relative flex-grow">
                    <input
                      ...
                      className="w-full bg-transparent border border-brandGold/50 focus:border-brandGold text-richEbony px-4 py-3 rounded-md focus:outline-none focus:ring-1 focus:ring-brandGold transition-all duration-300"
                      value={email}
                  ...
                  <button
                    type="submit"
                    className="bg-burgundy text-brandIvory px-6 py-3 rounded-md hover:bg-burgundy/90 transition duration-300 flex items-center justify-center group shadow-sm"
                  >
              ...
              <p className="text-xs text-platinumGray/70 mt-4">
                En vous inscrivant, vous acceptez notre <Link href="/privacy" className="underline hover:text-burgundy transition-colors">politique de confidentialité</Link>
              </p>
            </div>
          </div>
        </div>
