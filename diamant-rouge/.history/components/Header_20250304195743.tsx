...
export default function Header() {
  ...
  return (
    ...
    >
      {/* First Row: Contact & Logo & Icons */}
      <div className={`w-full ${isScrolled ? "bg-brandIvory/80 shadow-subtle" : "bg-brandIvory/70"}`}>
        <div className="max-w-screen-xl mx-auto px-4 py-2 flex items-center justify-between">
          ...
          {/* Right: Icons */}
          <div className="flex items-center gap-4">
            <Link href="/wishlist" className="relative hover-scale" title="Votre liste de souhaits">
            ...
            <Link href="/cart" className="relative hover-scale" title="Votre panier">
            ...
            {session ? (
              <>
                ...
                <button onClick={() => signOut()} className="hover-scale text-brandGold" title="Se déconnecter">
                  <LogOut size={22} />
                </button>
              </>
            ) : (
            ...
            {/* Theme Toggle */}
            <button onClick={handleThemeToggle} className="hover-scale" title="Changer de thème">
