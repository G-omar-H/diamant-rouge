  ...
  return (
    <header className="w-full bg-brandIvory">
      <div className="max-w-screen-xl mx-auto px-6 py-4 flex flex-col gap-4">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-6">
            <a
              ...
              className="flex items-center gap-1 text-richEbony hover:text-burgundy transition"
            ...
            <Link
              href="/appointments"
              className="flex items-center gap-1 text-richEbony hover:text-brandGold transition"
          ...
          <div className="flex-grow flex justify-center items-center">
            <Link
              ...
              className="relative w-64 h-24 hover:scale-105 transition-transform"
            >
              <Image
        ...
        <nav className="hidden md:flex justify-around mt-2 text-sm font-medium text-richEbony w-full">
          <Link href="/" className="hover:text-brandGold transition duration-300 text-center">
            Accueil
          </Link>
          <Link href="/collections" className="hover:text-brandGold transition duration-300 text-center">
            Collections
          </Link>
          <Link href="/appointments" className="hover:text-brandGold transition duration-300 text-center">
            Rendez-vous
          </Link>
          <Link href="/the-house" className="hover:text-brandGold transition duration-300 text-center">
            La Maison
          </Link>
          <Link href="/contact" className="hover:text-brandGold transition duration-300 text-center">
            Contact
          </Link>
        </nav>
      </div>
