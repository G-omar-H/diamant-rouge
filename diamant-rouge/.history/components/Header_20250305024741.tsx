    ...
    <header className="w-full bg-brandIvory">
      <div className="max-w-screen-xl mx-auto px-6 py-4 flex flex-col gap-4">
        ...
        <nav className="hidden md:flex justify-between mt-4 text-sm font-medium text-richEbony">
          <Link href="/" className="hover:text-brandGold transition duration-300 w-full text-center">
            Accueil
          </Link>
          <Link href="/collections" className="hover:text-brandGold transition duration-300 w-full text-center">
            Collections
          </Link>
          <Link href="/appointments" className="hover:text-brandGold transition duration-300 w-full text-center">
            Rendez-vous
          </Link>
          <Link href="/the-house" className="hover:text-brandGold transition duration-300 w-full text-center">
            La Maison
          </Link>
          <Link href="/contact" className="hover:text-brandGold transition duration-300 w-full text-center">
            Contact
          </Link>
        </nav>
      </div>
