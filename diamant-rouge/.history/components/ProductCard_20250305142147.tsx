    ...
    return (
        ...
        >
            ...
            <div className="relative overflow-hidden mb-5 aspect-[1/1]">
                ...
                {/* Wishlist heart icon - with high z-index and contrasting background */}
                <button
                    onClick={(e) => {
                        e.preventDefault();
                        handleWishlistToggle();
                    }}
                    className="absolute top-3 right-3 z-30 w-8 h-8 flex items-center justify-center bg-white/30 backdrop-blur-sm rounded-full"
                    ...
                    <Heart 
                        ...
                        className={`transition-all duration-300 ${
                            isInWishlist 
                                ...
                                : "fill-transparent stroke-richEbony hover:stroke-burgundy"
                        }`} 
                    />
                </button>
            </div>
