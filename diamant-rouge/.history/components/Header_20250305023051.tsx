...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 bg-brandIvory shadow-lg z-50">
      <div className="max-w-screen-xl mx-auto px-6 py-3 flex flex-col">
        {/* Top Row: Contact Links & User Actions */}
        <div className="flex justify-between items-center">
          ...
          <div className="flex-grow flex justify-center">
            <Link
              ...
              className="relative w-48 h-16 hover:scale-105 transition-transform"
            >
              <Image
        ...
        <nav className="hidden md:flex justify-center mt-2 space-x-8 text-sm font-medium text-richEbony">
