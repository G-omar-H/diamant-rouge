...
export default function Header() {
  ...
  const headerVariants = {
    initial: { 
      height: "auto",
      backgroundColor: "rgba(250, 243, 227, 0)", // Completely transparent initially
      boxShadow: "none"
    },
    scrolled: { 
      height: "90px", 
  ...
  return (
    ...
    >
      ...
      <div className={`w-full transition-colors duration-400 ${scrolled ? 'bg-brandIvory border-b border-brandGold/20 shadow-sm' : 'bg-transparent'}`}>
