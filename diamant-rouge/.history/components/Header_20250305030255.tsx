    ...
    <header className="w-full bg-brandIvory">
      <div className="max-w-screen-xl mx-auto px-6 py-4 flex flex-col gap-4">
        ...
        <nav className="hidden md:flex justify-between mt-4 text-sm font-medium text-richEbony">
          <Link href="/" className="flex-1 text-center hover:text-brandGold transition duration-300">
            Accueil
          </Link>
          <Link href="/collections" className="flex-1 text-center hover:text-brandGold transition duration-300">
            Collections
          </Link>
          <Link href="/appointments" className="flex-1 text-center hover:text-brandGold transition duration-300">
            Rendez-vous
          </Link>
          <Link href="/the-house" className="flex-1 text-center hover:text-brandGold transition duration-300">
            La Maison
          </Link>
          <Link href="/contact" className="flex-1 text-center hover:text-brandGold transition duration-300">
            Contact
          </Link>
        </nav>
      </div>
