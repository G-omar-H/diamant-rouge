  ...
  return (
    <header className="w-full bg-brandIvory">
      <div className="max-w-screen-xl mx-auto px-6 py-4 flex flex-col">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex-grow flex justify-center items-center">
            <Link
              ...
              className="relative w-57 h-33 hover:scale-105 transition-transform"
            >
              <Image
        ...
        <nav className="hidden md:flex justify-center mt-4 space-x-8 text-sm font-medium text-richEbony">
