        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="relative text-center">
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-brandIvory/60 mt-4">
                En vous inscrivant, vous acceptez notre <Link href="/privacy" className="underline hover:text-brandGold transition-colors">politique de confidentialité</Link>
              </p>
            </div>
          </div>
        </div>
