          ...
          <form className="max-w-md mx-auto flex" onSubmit={handleNewsletterSubmit}>
            <div className="relative flex-1">
              <input
                ...
                className="input-field w-full rounded-l-md rounded-r-none border-r-0"
                value={email}
            ...
            <button
              type="submit"
              className="bg-brandGold text-richEbony px-6 py-3 rounded-r-md hover:bg-burgundy hover:text-brandIvory transition duration-300 flex items-center justify-center group"
            >
