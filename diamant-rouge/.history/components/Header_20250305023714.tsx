    ...
    <header className="w-full bg-brandIvory">
      <div className="max-w-screen-xl mx-auto px-6 py-4 flex flex-col">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex-grow flex justify-center items-center">
            <Link
              ...
              className="relative w-56 h-20 hover:scale-105 transition-transform"
            >
              <Image
        ...
        <nav className="hidden md:flex justify-between mt-4 text-sm font-medium text-richEbony">
          <Link href="/" className="hover:text-brandGold transition duration-300 w-1/5 text-center">
            Accueil
          </Link>
          <Link href="/collections" className="hover:text-brandGold transition duration-300 w-1/5 text-center">
            Collections
          </Link>
          <Link href="/appointments" className="hover:text-brandGold transition duration-300 w-1/5 text-center">
            Rendez-vous
          </Link>
          <Link href="/the-house" className="hover:text-brandGold transition duration-300 w-1/5 text-center">
            La Maison
          </Link>
          <Link href="/contact" className="hover:text-brandGold transition duration-300 w-1/5 text-center">
            Contact
          </Link>
        </nav>
      </div>
