...
export default function Header() {
  ...
  // Handle scroll effect with more precise threshold
  useEffect(() => {
    const handleScroll = () => {
  ...
  // Refined animation variants for a more elegant transition
  ...
  return (
    ...
    >
      ...
      <div className={`w-full bg-brandIvory ${scrolled ? 'border-b border-brandGold/20' : ''}`}>
        ...
        <div className="mx-auto flex flex-col">
          ...
          {/* Main Row: Adjusts layout based on scroll position */}
          <div className={`flex items-center w-full ${scrolled ? 'h-[90px] px-8' : 'py-3 px-4 md:px-8'}`}>
            {/* When scrolled, show the left navigation */}
            {scrolled ? (
              <>
            ...
            {/* Center: Logo - size changes based on scroll and view */}
            <div className={`flex justify-center items-center ${scrolled ? 'flex-1' : 'flex-grow'}`}>
              <Link
                href="/"
            ...
            {/* Right: Icons */}
            <div className={`flex items-center ${scrolled ? 'ml-6 gap-5' : 'gap-6'}`}>
              <button 
              ...
              <div className="p-6 border-t border-brandGold/10 bg-brandGold/5">
                <div className="flex flex-col gap-3 text-sm">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <a 
                      href="https://wa.me/212555000111" 
                      className="text-richEbony hover"
                    >
                      WhatsApp
                    </a>
                  </div>
