...
export default function HeroCarousel({
  ...
  return (
    ...
    >
      ...
      {/* Full-width image container - using object-contain to show entire image */}
      <div className="relative w-full h-full">
        <AnimatePresence mode="wait">
          ...
          >
            {/* Background fill for any empty space */}
            <div className="absolute inset-0 bg-richEbony"></div>
            
            {/* Main image - using object-contain to show entire image */}
            <Image
