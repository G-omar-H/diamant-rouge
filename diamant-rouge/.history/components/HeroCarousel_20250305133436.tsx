...
export default function HeroCarousel({
  ...
  const getTextPosition = (position = "right") => {
    switch(position) {
      case "left": return "left-6 md:left-12 lg:left-20 items-start text-left";
      case "center": return "left-1/2 -translate-x-1/2 items-center text-center";
      case "right": return "right-6 md:right-12 lg:right-20 items-end text-right";
      default: return "right-6 md:right-12 lg:right-20 items-end text-right";
    }
  };
  ...
  return (
    ...
    >
      {/* Full-width image container with better aspect ratio control */}
      <div className="relative w-full h-full">
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="absolute inset-0 bg-richEbony"></div>
            
            {/* Main image - sized to maintain aspect ratio within the full width */}
            <Image
            ...
            {/* Thin decorative borders at screen edges */}
            <div className="absolute top-4 left-4 right-4 bottom-4 border border-brandGold/10 z-20"></div>
          </motion.div>
        </AnimatePresence>
