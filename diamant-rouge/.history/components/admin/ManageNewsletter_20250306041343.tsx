...
function generateNewsletterHtml() {
  const siteUrl = typeof window !== 'undefined' ? window.location.origin : 'localhost:3000';
  ...
  return `
    ...
    <body>
      <div class="container">
        <div class="header">
          <!-- Use a direct, absolute path to the logo -->
          <img src="${siteUrl}/images/logo1.jpeg" alt="Diamant Rouge" class="logo">
        </div>
        ...
        <div class="content">
          ...
          <div class="social-links">
            <!-- Use absolute URLs for social icons -->
            <a href="https://instagram.com/diamantrouge" aria-label="Instagram">
              <img src="${siteUrl}/images/socials/instagram.png" alt="Instagram" class="social-icon">
            </a>
            <a href="https://facebook.com/diamantrouge" aria-label="Facebook">
              <img src="${siteUrl}/images/socials/facebook.png" alt="Facebook" class="social-icon">
            </a>
          </div>
          
          <p style="margin-top: 20px;">
            <a href="${siteUrl}/unsubscribe" style="color: #d4af37;">Se désabonner</a>
          </p>
        </div>
      </div>
    </body>
