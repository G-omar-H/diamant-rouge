...
export function ManageCategories() {
    ...
    return (
        <div className="p-6 section-light">
            ...
            {/* 2) List of Existing Categories - prioritize French translations */}
            <ul className="space-y-4 mt-8">
                {categories.map((cat) => {
                    // Prioritize French translation
                    const catTranslation = cat.translations.find((t: any) => t.language === "fr") || 
                                         cat.translations[0] || {};
                    return (
                        <li
                            key={cat.id}
                        ...
                        >
                            <div>
                                <strong className="text-richEbony">
                                    {catTranslation.name || cat.slug}
                                </strong>{" "}
                                - {catTranslation.description || "Pas de description"}
                            </div>
