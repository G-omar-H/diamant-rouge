    ...
    return (
        ...
        >
            ...
            <div className="relative overflow-hidden mb-5">
                ...
                {/* Wishlist heart icon - more elegant and refined */}
                <motion.button
                    onClick={(e) => {
                        e.preventDefault();
                    ...
                    initial={{ opacity: 0.7 }}
                    animate={{ opacity: hovered || isInWishlist ? 1 : 0.7 }}
            ...
            {/* Product Details - Refined left alignment */}
            <div className="px-0">
                {/* Product Name */}
                ...
                {/* View Product Link - more elegant styling */}
